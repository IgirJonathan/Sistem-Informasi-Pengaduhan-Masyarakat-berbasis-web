                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        ...
                                        <span class="badge badge-sm bg-info">
                                            <a href="#" data-bs-toggle="modal" data-bs-target="#reset<?= $data['nik'] ?>" style="text-decoration: none; color:white;">RESET</a>
                                        </span>
                                        <!-- HAPUS -->
                                        ...
                                        <!-- modal EDIT -->
                                        <div class="modal fade" id="edit<?= $data['nik'] ?>" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="editLabel">Edit Data Masyarakat</h1>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="edit_masyarakat" class="btn btn-primary">Simpan</button>
                                                    </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <!-- modal RESET -->
                                        <div class="modal fade" id="reset<?= $data['nik'] ?>" tabindex="-1" aria-labelledby="resetLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="edit_data.php" method="POST">
                                                            <input type="hidden" name="nik" value="<?= $data['nik']; ?>">
                                                            <p>Yakin reset password <?= $data['nama']; ?> ke default (123456)?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" name="reset_masyarakat" class="btn btn-warning">Reset</button>
                                                    </div>
                                                    </form>
                                                </div>
                                            </div>
