        ...
        <div class="card-body p-4 p-sm-5">
          ...
          <form action="" method="POST">
            <div class="">
              ...
              <input type="number" class="form-control" name="nik" id="nik" placeholder="Masukan NIK Anda" required autocomplete="off" autofocus>
            </div>
            <div class="">
...
if (isset($_POST["kirim"])) {
  ...
  $query = mysqli_query($conn, "INSERT INTO masyarakat 
                        VALUES ('$nik','$nama','$username','$password','$telp','$level', NULL) ");
